...
@section('content')
    <div class="ui stackable grid container" style="padding-top: 50px; padding-bottom: 50px">
        <div class="twelve wide column">
            <div class="ui basic segment bgWhite roundBordered">
                <h1 class="ui dividing header">
                    Post a Job
                    <div class="sub header">Be descriptive as possible with your job post.</div>
                </h1>
        ...
        <div class="four wide column">
            <div class="ui basic segment bgWhite roundBordered">
                <h4 class="ui tiny dividing header">How does it works?</h4>
                <p>
                    Posting a job is <strong>TOTALLY FREE</strong> (while in Beta), your job post will be open for 60 days after which it will automatically expire (that's if you don't close it first).
                </p>
                <p>
            ...
            <div class="ui basic segment bgWhite roundBordered">
                <h4 class="ui tiny dividing header">Why post on Naijadevs?</h4>
                <p>
